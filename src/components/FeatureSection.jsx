...
const FeatureSection = () => {
  return (
    <div id="features" className="fsAnimation relative mt-[50px] mx-[25px] lg:mx-[100px]  border-b border-neutral-800 min-h-[800px]">
      <div className="text-center">
        ...
        <h2 className="font-[500] text-3xl sm:text-5xl lg:text-6xl mt-10 lg:mt-[50px] tracking-wide">Easily build
        ...
        {features.map((feature, index) => (
          <div key={index} className="w-full sm:1/2 lg:w-1/3">
            <div className="flex">
              ...
              <div>
                <h5 className="mt-1 mb-4 lg:mb-6 text-xl">{feature.text}</h5>
                <p className="text-md p-2 mb-16 lg:mb-20 text-neutral-500">{feature.description}</p>
              </div>
            </div>
          </div>
        ))}
